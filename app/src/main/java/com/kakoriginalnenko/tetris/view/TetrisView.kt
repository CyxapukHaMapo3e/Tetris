package com.kakoriginalnenko.tetris.view
...
import com.kakoriginalnenko.tetris.GameActivity
import com.kakoriginalnenko.tetris.constants.CellConstants
import com.kakoriginalnenko.tetris.constants.FieldConstants
import com.kakoriginalnenko.tetris.models.AppModel
import com.kakoriginalnenko.tetris.models.Block
            ...
            if(msg.what == 0){
                if(owner.model != null){
                    if (owner.model!!.isGameOver()){
                        owner.model?.endGame()
                        Toast.makeText(owner.activity,"Game over man", Toast.LENGTH_LONG).show()
                    }
